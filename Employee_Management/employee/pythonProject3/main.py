...
style = ttk.Style()
style.configure("mystyle.Treeview", font=('Calibri', 8), rowheight=50)
...
tv.column("5", width=40)
tv.heading("6", text="Gender")
tv.column("6", width=8)
tv.heading("7", text="Contact")
tv.column("7", width=10)
tv.heading("8", text="Address")
tv.column("8", width=250)
...
# Bind events to handle row selection
tv.bind("<ButtonRelease-1>", lambda event: getData)

# Call to display all data (assuming the function exists)
dispalyAll()
